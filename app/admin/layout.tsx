...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-72 bg-white border-r border-stone-200 transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-6 border-b border-stone-100">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="lg:hidden ml-auto p-2 rounded-lg hover:bg-stone-100"
          >
      ...
      <div className="lg:ml-72 min-h-screen">
        {/* Top Bar */}
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-stone-200 px-4 sm:px-6 lg:px-8 py-4">
